...
class BlogPostsModule extends FLBuilderModule {
	...
	public function __construct() {
		...
		parent::__construct(
			array(
				'name'            => __( 'Advanced Posts (edited)', 'uabb' ),
...
if ( UABB_Compatibility::$version_bb_check ) {
	require_once get_stylesheet_directory() . '/bb-ultimate-addon/modules/blog-posts/blog-posts-bb-2-2-compatibility.php';
} else {
	require_once get_stylesheet_directory() . '/bb-ultimate-addon/modules/blog-posts/blog-posts-bb-less-than-2-2-compatibility.php';
}
