			...
			'sections' => array(
				'image_settings' => array(
			        ...
			        'fields' => array(
			            'show_filters' => array(
							'type'    => 'select',
							'label'   => __( 'Show filters', 'uabb' ),
							'help'    => __( 'Enable this to display filters.', 'uabb' ),
							'default' => 'yes',
							'options' => array(
								'yes' => __( 'Yes', 'uabb' ),
								'no'  => __( 'No', 'uabb' ),
			            ...
			            'groep' => array(
			                'type' => 'select',
			                'label' => __('Groep', 'textdomain'),
			                'default' => 'damesschoenen',
			                'options' => array(
			                    'damesschoenen' => __('Damesschoenen', 'textdomain'),
			                    'herenschoenen' => __('Herenschoenen', 'textdomain'),
			                ),
			            ),
			        ),
			    ),
